...
class GetDataSet(object):
    def __init__(self, dataSetName, num_of_clients, isIID):
        ...
        if self.name == 'mnist':
            self.mnistDataSetConstruct(self.num_of_clients, isIID)
    ...
    def mnistDataSetConstruct(self, num_of_clients, isIID):
        ...
        # if isIID:
        #     dict_users = mnist_iid(dataset_train, num_of_clients)
        # else:
        #     dict_users = mnist_noniid(dataset_train, num_of_clients)

    def cifar10DataSetConstruct(self, isIID):
        data_dir = r'.\data\cifar'
        train_images_path = os.path.join(data_dir, 'data_batch_1')
        test_images_path = os.path.join(data_dir, 'test_batch')
        ...
        train_labels = []
        for i in range(1, 6):
            with open(os.path.join(data_dir, 'data_batch_' + str(i)), 'rb') as f:
